      ...
      <form>
        ...
        <div className="flex items-center mt-2">
          <button
            ...
            hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-300 
            ease-in-out w-full ${
              type === "rent"
                ? "bg-white text-black"
        ...
        <input
          ...
          rounded transition duration-300 ease-in-out focus:text-gray-700 focus: focus:bg-white
